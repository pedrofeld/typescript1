import { Carteira, Produtos, Usuario } from "./interface";
import { media, media2, movimentarCarteira, cadastrarProduto, listarProdutos, excluirProduto, cadastrarUsuario, listarUsuarios, cadastrarUsuarioDiretor, listarDiretores, listarPessoas } from "./funcoes";
...
const resultado2 = media2(9, 9, 9, 1, 2, 3); // 3 notas no início e a sequência dos últimos 3 números é o peso de cada nota respectivamente
...
cadastrarProduto("Lápis", 10)
cadastrarProduto("Caderno", 20)
listarProdutos()
excluirProduto(1)
listarProdutos()
...
cadastrarUsuario("Pedro", 19, "CPO", 20000000)
cadastrarUsuario("Maria", 20, "estagiária")
listarUsuarios()
...
cadastrarUsuarioDiretor("Joana", 19, 5, 20000000)
cadastrarUsuarioDiretor("Joaquim", 20, 1)
listarDiretores()
